...
Route::middleware(['auth:sanctum', 'verified', 'active.user'])->group(function () {
    ...
    Route::get('/nurselink/admin/membership-administration/export-history', [\App\Http\Controllers\Api\MembershipAdministrationController::class, 'exportHistory'])->middleware(\App\Http\Middleware\EnsureNurseLinkAdminPermission::class);
