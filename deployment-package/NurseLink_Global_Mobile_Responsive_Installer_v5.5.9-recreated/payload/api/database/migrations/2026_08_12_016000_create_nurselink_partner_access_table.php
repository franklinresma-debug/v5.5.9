...
return new class extends Migration
{
    public function up(): void
    {
        $this->recreateEmptyIncompatibleTable(
            ...
            function (): void {
                Schema::create('nurselink_partner_access', function (Blueprint $table): void {
                    $table->id();
                    ...
                    $table->index(['partner_organization_id', 'active']);
    ...
    {
        Schema::dropIfExists('nurselink_partner_access');
    }
