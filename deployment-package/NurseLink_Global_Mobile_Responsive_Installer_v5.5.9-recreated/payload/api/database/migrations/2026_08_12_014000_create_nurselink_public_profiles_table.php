...
return new class extends Migration
{
    public function up(): void
    {
        $this->recreateEmptyIncompatibleTable(
            ...
            function (): void {
                Schema::create('nurselink_public_profiles', function (Blueprint $table): void {
                    $table->id();
                    ...
                    $table->boolean('show_member_number')->default(true);
                    $table->boolean('show_credentials')->default(true);
                    $table->boolean('show_employment')->default(true);
                    $table->boolean('show_portfolio')->default(true);
                    $table->boolean('show_learning')->default(true);
    ...
    {
        Schema::dropIfExists('nurselink_public_profiles');
    }
