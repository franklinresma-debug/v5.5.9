...
return new class extends Migration
{
    public function up(): void
    {
        $this->recreateEmptyIncompatibleTable(
            ...
            function (): void {
                Schema::create('nurselink_job_applications', function (Blueprint $table): void {
                    $table->id();
                    ...
                    $table->unique(['user_id', 'job_opportunity_id'], 'nlja_user_job_unique');
    ...
    {
        Schema::dropIfExists('nurselink_job_applications');
    }
