...
return new class extends Migration
{
    public function up(): void
    {
        $this->recreateEmptyIncompatibleTable(
            ...
            function (): void {
                Schema::create('nurselink_reviewer_access', function (Blueprint $table): void {
                    $table->id();
                    $this->userIdDefinition($table);
                    $table->string('role', 30)->default('reviewer');
    ...
    {
        Schema::dropIfExists('nurselink_reviewer_access');
    }
