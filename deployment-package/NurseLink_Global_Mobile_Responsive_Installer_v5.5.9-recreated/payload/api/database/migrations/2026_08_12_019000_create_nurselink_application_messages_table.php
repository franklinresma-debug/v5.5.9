...
return new class extends Migration
{
    public function up(): void
    {
        $this->recreateEmptyIncompatibleTable(
            ...
            function (): void {
                Schema::create('nurselink_application_messages', function (Blueprint $table): void {
                    $table->id();
                    ...
                    $table->timestamp('read_by_partner_at')->nullable();
                    $table->timestamps();

                    $table->index(['job_application_id', 'created_at'], 'nlam_application_created_idx');
                    $table->index(['partner_organization_id', 'created_at'], 'nlam_partner_created_idx');
                    $table->index(['sender_type', 'created_at'], 'nlam_sender_created_idx');
                });
            }
        );
    }
    ...
    {
        Schema::dropIfExists('nurselink_application_messages');
    }
