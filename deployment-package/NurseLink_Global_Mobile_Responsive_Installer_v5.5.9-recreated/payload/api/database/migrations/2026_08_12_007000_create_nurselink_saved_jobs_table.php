...
return new class extends Migration
{
    public function up(): void
    {
        $this->recreateEmptyIncompatibleTable(
            ...
            function (): void {
                Schema::create('nurselink_saved_jobs', function (Blueprint $table): void {
                    $table->id();
                    $this->userIdDefinition($table);
                    $table->unsignedBigInteger('job_opportunity_id');
                    $table->timestamps();

                    $table->unique(['user_id', 'job_opportunity_id'], 'nlsj_user_job_unique');
    ...
    {
        Schema::dropIfExists('nurselink_saved_jobs');
    }
